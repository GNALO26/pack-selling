...
export default function ProtectedLayout({
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "var(--bg-void)" }}>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-60 flex flex-col transition-transform duration-300 lg:translate-x-0",
      ...
      <div className="flex-1 lg:ml-60 flex flex-col min-h-screen">
        <header
          className="h-14 flex items-center px-4 sm:px-6 sticky top-0 z-30"
          style={{
            background: "var(--bg-deep)",
        ...
        >
          ...
          {user?.role === "admin" && (
            <span className="badge-magenta badge text-xs mr-2">ADMIN</span>
          )}
          <div
